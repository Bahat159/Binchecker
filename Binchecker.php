...
<div class="text-warning" style="background-color: #222">
        <nav class="navbar navbar-expand-md ">
            <div class="container"><a class="navbar-brand" href="#" style="letter-spacing:2px;">Bin Checker</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div
...
<div class="footer-copyright ">
    <?php echo '© 2020 Copyright | SandCroft Tech'; ?>
  </div>
</footer>
</html>
